  ...
  return (
    <>
      <Container className="mt-4" style={{ marginBottom: "100px" }}>
        ...
        {lastWorkoutDetails &&
          isSameDay(new Date(lastWorkoutDetails.createdAt), currentDate) && (
              ...
              <Row>
                <Col>
                  ...
                  {lastWorkoutDetails.createdAt && (
                    <p className="mb-1">
                      {`${new Date(lastWorkoutDetails.createdAt).toLocaleString(
                        "en-US",
                        {
              ...
              <Row>
                <Col>
                  ...
                  {typeof Number(lastWorkoutDetails.attempts) === "number" && (
                    <p className="mb-1">
                      {lastWorkoutDetails.attempts} attempts
                    </p>
                  )}
